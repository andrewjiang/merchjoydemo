  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved cart as @cart" do
        ...
        post :create, {:cart => { "user" => "invalid value" }}, valid_session
        assigns(:cart).should be_a_new(Cart)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested cart" do
        ...
        Cart.any_instance.should_receive(:update).with({ "user" => "MyString" })
        put :update, {:id => cart.to_param, :cart => { "user" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the cart as @cart" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Cart.any_instance.stub(:save).and_return(false)
        put :update, {:id => cart.to_param, :cart => { "user" => "invalid value" }}, valid_session
        assigns(:cart).should eq(cart)
      end
